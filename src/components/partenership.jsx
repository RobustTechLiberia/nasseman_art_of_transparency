...
class Partenership extends React.Component {
    render(){
        ...
        return(
           ...
           <>
    <div id="partnership">
  <div className="bg-black/80 bg-blend-overlay h-96 w-auto mt-60 flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat object-cover inset-0 z-0">
    
    <h1 className="text-white text-4xl font-sans font-semibold mt-2 uppercase mx-5 md:w-xl text-center">
      become a partner<br />against corruption
    </h1>
    ...
    <button className="bg-red-900 py-3 px-8 rounded-sm text-white capitalize text-2xl cursor-pointer hover:bg-red-800 transition">
